          ...
          <AnimatePresence mode="popLayout">
            {hoveredIndex === item.id && (
              <motion.div
                ...
                className="absolute -top-16 -left-1/2 translate-x-1/2 flex text-xs  flex-col items-center justify-center rounded-md bg-main border-2 border-border dark:border-darkBorder shadow-light dark:shadow-dark z-50 px-4 py-2"
              >
